...
```
python run_expt.py -s confounder -d CUB -t waterbird_complete95 -c forest2water2 --lr 1e-5 --batch_size 128 --weight_decay 1 --model resnet50 --n_epochs 300 --reweight_groups --robust --gamma 0.1 --generalization_adjustment 2 --root_dir '../slice-and-dice-smol/datasets/data/Waterbirds/' --pred_groups_path ./group_predictions/waterbirds/group_preds_best_f1_macro_supcon.npy

python run_expt.py -s confounder -d CUB -t waterbird_complete95 -c forest2water2 --lr 1e-5 --batch_size 128 --weight_decay 1 --model resnet50 --n_epochs 300 --reweight_groups --robust --gamma 0.1 --generalization_adjustment 2 --root_dir '../slice-and-dice-smol/datasets/data/Waterbirds/' --pred_groups_path ./group_predictions/waterbirds/group_preds_best_f1_macro_simclr.npy

python run_expt.py -s confounder -d CUB -t waterbird_complete95 -c forest2water2 --lr 1e-5 --batch_size 128 --weight_decay 1 --model resnet50 --n_epochs 300 --reweight_groups --robust --gamma 0.1 --generalization_adjustment 2 --root_dir '../slice-and-dice-smol/datasets/data/Waterbirds/' --pred_groups_path ./group_predictions/waterbirds/group_preds_best_f1_macro_lspread_as1.0.npy

python run_expt.py -s confounder -d CUB -t waterbird_complete95 -c forest2water2 --lr 1e-5 --batch_size 128 --weight_decay 1 --model resnet50 --n_epochs 300 --reweight_groups --robust --gamma 0.1 --generalization_adjustment 2 --root_dir '../slice-and-dice-smol/datasets/data/Waterbirds/' --pred_groups_path ./group_predictions/waterbirds/group_preds_best_f1_macro_lspread_as2.0.npy

python run_expt.py -s confounder -d CUB -t waterbird_complete95 -c forest2water2 --lr 1e-5 --batch_size 128 --weight_decay 1 --model resnet50 --n_epochs 300 --reweight_groups --robust --gamma 0.1 --generalization_adjustment 2 --root_dir '../slice-and-dice-smol/datasets/data/Waterbirds/' --pred_groups_path ./group_predictions/waterbirds/group_preds_cross_entropy.npy --seed 1

```
where the numpy array should be the same size as the training data set. Values `[0, 0, 1, 1, 2, 2]` means that the 1st two samples belong to Group 0, the second two belong to group 1 and the 3rd two belong to group 2 (all inferred). 
